    ...
    <div class=" logo_nav">
        ...
        <label for="">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="40" fill="currentColor" class="bi bi-list pos_icon" viewBox="0 0 16 16">
        ...
        <nav>
            <menu> 
                ...
                <a href="/emergency-contact">Contact</a>
            </menu>
            <menu>
                    ...
                    <div class="div_logout">
                        ...
                        <div class="pos_img">
                            <a href="/profile/company">
                                @if(session()->has('info_entr') && session('info_entr')->image)
                                    <img src="{{ asset('storage/' . session('info_entr')->image) }}" >
                                @else
                ...
                @elseif(session()->has('token_employee')) 
                    <div class="div_logout">
                        ...
                        <div class="pos_img"><a href="/profile/employee">
                            @if(session()->has('info_emp') && session('info_emp')->image )
                                <img src="{{ asset('storage/' . session('info_emp')->image) }}" >
                            @else
                                <img src="{{ asset('storage/profile.png') }}" >
                            @endif
                        </a></div>  
                ...
                @else
                    ...
                    <a href="/entreprise/step-one" class="sing_up">Sing up</a>
                @endif
            </menu>
        </nav>
    </div>
