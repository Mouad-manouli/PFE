<x-master_profile_company title='Report' :company='$company' :contrat='$contrat'>
    <div class="tout_rapport_emp" style="width: 100%;">
       @foreach ($rapports as $key => $rap )
           <div class="detail_rapport">
                <h6>{{ $machines_nom[$rap->id] }}</h6> 
                <span>
